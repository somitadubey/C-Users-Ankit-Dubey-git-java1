...
<body>
	<h1>Master list of all the subjects for all the classes is : </h1>
	<div class="panel-body">
				<table id="tbl-course" class="table table-responsive table-bordered">
					...
					<tbody>
						...
						String query =("SELECT subject.id, c.className, c.classDuration, s.subjectName , s.subjectDuration from ph2_la.class c JOIN ph2_la.subject ON subject.id = c.id JOIN ph2_la.subject s ON subject.id");
